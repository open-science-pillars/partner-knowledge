...
A provider repository: knowledge bundles keyed by the organization that signs their facts. Pillar means sphere: one of the five Earth science spheres; a capability is skills, knowledge signed by its stewards and deterministic checks, delivered as one plugin.
